...
+ (OakCommandRefresher*)scheduleRefreshForCommand:(OakCommand*)aCommand options:(OakCommandRefresherOptions)options variables:(std::map<std::string, std::string> const&)variables document:(OakDocument*)document window:(NSWindow*)window
{
	OakCommandRefresher* refresher = [[OakCommandRefresher alloc] initWithCommand:aCommand options:options variables:variables document:document window:window];
...
- (id)initWithCommand:(OakCommand*)aCommand options:(OakCommandRefresherOptions)options variables:(std::map<std::string, std::string> const&)variables document:(OakDocument*)document window:(NSWindow*)window
{
	if((self = [super init]))
	{
		_command  = aCommand;
