...
- (BOOL)validateMenuItem:(NSMenuItem*)item
{
	...
	{
		if(id menuItemValidator = [NSApp.keyWindow.delegate respondsToSelector:@selector(performBundleItem:)] ? NSApp.keyWindow.delegate : [NSApp targetForAction:@selector(performBundleItem:)])
		{
			if([menuItemValidator respondsToSelector:@selector(validateMenuItem:)])
