	...
	MBMenu const items = {
		{ @"TextMate",
			.submenu = {
				...
				{ @"Check for Test Builds", @selector(performSoftwareUpdateCheck:),       .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask, .alternate = YES },
				{ /* -------- */ },
				{ @"Services",              .systemMenu = MBMenuTypeServices               },
				{ /* -------- */ },
				{ @"Hide TextMate",         @selector(hide:),                       @"h"   },
				{ @"Hide Others",           @selector(hideOtherApplications:),      @"h", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
		...
		{ @"File",
			.submenu = {
				...
				{ @"New File Browser",        @selector(newFileBrowser:),           @"n", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask|NSControlKeyMask, .alternate = YES },
				{ @"New Tab",                 @selector(newDocumentInTab:),         @"n", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
				{ /* -------- */ },
				...
				{ @"Close All Tabs",          @selector(performCloseAllTabs:),      @"w", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask|NSControlKeyMask },
				{ @"Close Other Tabs",        @selector(performCloseOtherTabsXYZ:), @"w", .modifierFlags = NSCommandKeyMask|NSControlKeyMask },
				...
				{ @"Save All",                @selector(saveAllDocuments:),         @"s", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
			...
			.submenu = {
				...
				{ @"Paste",
					.submenu = {
						...
						{ @"Paste Without Indenting", @selector(pasteWithoutReindent:), @"v", .modifierFlags = NSCommandKeyMask|NSControlKeyMask, .alternate = YES },
						{ @"Paste Next",              @selector(pasteNext:),            @"v", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
						{ @"Paste Previous",          @selector(pastePrevious:),        @"V"   },
						{ /* -------- */ },
						{ @"Show History",            @selector(showClipboardHistory:), @"v", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask|NSControlKeyMask },
					}
				},
				...
				{ @"Macros",
					.submenu = {
						{ @"Start Recording", @selector(toggleMacroRecording:), @"m", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
						{ @"Replay Macro",    @selector(playScratchMacro:),     @"M"   },
						{ @"Save Macro…",     @selector(saveScratchMacro:),     @"m", .modifierFlags = NSCommandKeyMask|NSControlKeyMask },
					}
				},
				{ /* -------- */ },
				{ @"Select",
					.submenu = {
						...
						{ /* -------- */ },
						{ @"Toggle Column Selection", @selector(toggleColumnSelection:), .modifierFlags = NSAlternateKeyMask },
					}
				},
				{ @"Find",
					.submenu = {
						...
						{ /* -------- */ },
						{ @"Show Find History",           @selector(showFindHistory:),              @"f", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask|NSControlKeyMask },
						{ /* -------- */ },
						{ @"Incremental Search",          @selector(incrementalSearch:),            @"s", .modifierFlags = NSControlKeyMask },
						{ @"Incremental Search Previous", @selector(incrementalSearchPrevious:),    @"S", .modifierFlags = NSControlKeyMask },
						{ /* -------- */ },
						{ @"Find Next",                   @selector(findNext:),                     @"g"   },
						{ @"Find Previous",               @selector(findPrevious:),                 @"G"   },
						{ @"Find All",                    @selector(findAllInSelection:),           @"f", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
						{ /* -------- */ },
						{ @"Find Behavior",
							.submenu = {
								{ @"Ignore Case",        @selector(toggleFindOption:), @"c", .tag =   2, .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
								{ @"Regular Expression", @selector(toggleFindOption:), @"r", .tag =   8, .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
								{ @"Ignore Whitespace",  @selector(toggleFindOption:),       .tag =   4  },
								{ @"Wrap Around",        @selector(toggleFindOption:), @"a", .tag = 128, .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
							}
						},
						{ /* -------- */ },
						{ @"Replace",                     @selector(replace:),                      @"g", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
						{ @"Replace & Find",              @selector(replaceAndFind:)                       },
						{ @"Replace All",                 @selector(replaceAll:),                   @"g", .modifierFlags = NSCommandKeyMask|NSControlKeyMask },
						{ @"Replace All in Selection",    @selector(replaceAllInSelection:),        @"G", .modifierFlags = NSCommandKeyMask|NSControlKeyMask },
						{ /* -------- */ },
				...
				{ @"Spelling",
					.submenuRef = &spellingMenu, .submenu = {
						...
						{ @"Check Spelling as You Type", @selector(toggleContinuousSpellChecking:), @";", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
						{ /* -------- */ },
					}
				},
			}
		...
		{ @"View",
			.submenu = {
				...
				{ @"Show File Browser",      @selector(toggleFileBrowser:),    @"d", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask|NSControlKeyMask },
				{ @"Show HTML Output",       @selector(toggleHTMLOutput:),     @"h", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask|NSControlKeyMask },
				{ @"Show Line Numbers",      @selector(toggleLineNumbers:),    @"l", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
				{ /* -------- */ },
				{ @"Show Invisibles",        @selector(toggleShowInvisibles:), @"i", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
				{ /* -------- */ },
				{ @"Enable Soft Wrap",       @selector(toggleSoftWrap:),       @"w", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
				...
				{ @"Toggle Foldings at Level",
					.submenu = {
						{ @"All Levels", @selector(takeLevelToFoldFrom:), @"0", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
						{ @"1",          @selector(takeLevelToFoldFrom:), @"1", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask, .tag = 1 },
						{ @"2",          @selector(takeLevelToFoldFrom:), @"2", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask, .tag = 2 },
						{ @"3",          @selector(takeLevelToFoldFrom:), @"3", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask, .tag = 3 },
						{ @"4",          @selector(takeLevelToFoldFrom:), @"4", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask, .tag = 4 },
						{ @"5",          @selector(takeLevelToFoldFrom:), @"5", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask, .tag = 5 },
						{ @"6",          @selector(takeLevelToFoldFrom:), @"6", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask, .tag = 6 },
						{ @"7",          @selector(takeLevelToFoldFrom:), @"7", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask, .tag = 7 },
						{ @"8",          @selector(takeLevelToFoldFrom:), @"8", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask, .tag = 8 },
						{ @"9",          @selector(takeLevelToFoldFrom:), @"9", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask, .tag = 9 },
					}
				},
				{ /* -------- */ },
				{ @"Toggle Scroll Past End", @selector(toggleScrollPastEnd:)          },
				{ /* -------- */ },
				{ @"View Source",            @selector(viewSource:),           @"u", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
				{ @"Enter Full Screen",      @selector(toggleFullScreen:),     @"f", .modifierFlags = NSCommandKeyMask|NSControlKeyMask },
			}
		},
		{ @"Navigate",
			.submenu = {
				...
				{ @"Jump to Previous Bookmark",  @selector(goToPreviousBookmark:),         .key = NSF2FunctionKey, .modifierFlags = NSShiftKeyMask },
				...
				{ @"Jump To Previous Mark",      @selector(jumpToPreviousMark:),           .key = NSF3FunctionKey, .modifierFlags = NSShiftKeyMask },
				{ /* -------- */ },
				{ @"Scroll",
					.submenu = {
						{ @"Line Up",      @selector(scrollLineUp:),      .key = NSUpArrowFunctionKey,    .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask|NSControlKeyMask },
						{ @"Line Down",    @selector(scrollLineDown:),    .key = NSDownArrowFunctionKey,  .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask|NSControlKeyMask },
						{ @"Column Left",  @selector(scrollColumnLeft:),  .key = NSLeftArrowFunctionKey,  .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask|NSControlKeyMask },
						{ @"Column Right", @selector(scrollColumnRight:), .key = NSRightArrowFunctionKey, .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask|NSControlKeyMask },
					}
				},
				{ /* -------- */ },
				{ @"Go to Related File",         @selector(goToRelatedFile:),              .key = NSUpArrowFunctionKey, .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
				{ /* -------- */ },
				{ @"Move Focus to File Browser", @selector(moveFocus:),                    .key = NSTabCharacter, .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask },
			}
		},
		{ @"Text",
			.submenu = {
				...
				{ @"Move Selection",
					.submenu = {
						{ @"Up",    @selector(moveSelectionUp:),    .key = NSUpArrowFunctionKey,    .modifierFlags = NSCommandKeyMask|NSControlKeyMask },
						{ @"Down",  @selector(moveSelectionDown:),  .key = NSDownArrowFunctionKey,  .modifierFlags = NSCommandKeyMask|NSControlKeyMask },
						{ @"Left",  @selector(moveSelectionLeft:),  .key = NSLeftArrowFunctionKey,  .modifierFlags = NSCommandKeyMask|NSControlKeyMask },
						{ @"Right", @selector(moveSelectionRight:), .key = NSRightArrowFunctionKey, .modifierFlags = NSCommandKeyMask|NSControlKeyMask },
					}
				},
				{ /* -------- */ },
		...
		{ @"File Browser",
			.submenu = {
				{ @"New File",         @selector(newDocumentInDirectory:), @"n", .modifierFlags = NSCommandKeyMask|NSControlKeyMask },
				...
				{ /* -------- */ },
				{ @"Select Document",  @selector(revealFileInProject:),    @"r", .modifierFlags = NSCommandKeyMask|NSControlKeyMask },
		...
		{ @"Bundles",
			.submenuRef = &bundlesMenu, .submenu = {
				{ @"Select Bundle Item…", @selector(showBundleItemChooser:), @"t", .modifierFlags = NSCommandKeyMask|NSControlKeyMask },
				{ @"Edit Bundles…",       @selector(showBundleEditor:),      @"b", .modifierFlags = NSCommandKeyMask|NSAlternateKeyMask|NSControlKeyMask },
				{ /* -------- */ },
			}
		},
		{ @"Window",
