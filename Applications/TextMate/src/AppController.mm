	...
	MBMenu const items = {
		...
		{ @"Window",
			.systemMenu = MBMenuTypeWindows, .submenu = {
				...
				{ /* -------- */ },
				{ @"Select Previous Tab",    @selector(selectPreviousTab:),     .key = NSTabCharacter,          .modifierFlags = NSEventModifierFlagControl|NSEventModifierFlagShift },
				{ @"Select Next Tab",        @selector(selectNextTab:),         .key = NSTabCharacter,          .modifierFlags = NSEventModifierFlagControl },
				{ @"Select Previous Tab",    @selector(selectPreviousTab:),     .key = NSLeftArrowFunctionKey,  .modifierFlags = NSEventModifierFlagOption|NSEventModifierFlagCommand, .hidden = YES },
				{ @"Select Next Tab",        @selector(selectNextTab:),         .key = NSRightArrowFunctionKey, .modifierFlags = NSEventModifierFlagOption|NSEventModifierFlagCommand, .hidden = YES },
				{ @"Select Previous Tab",    @selector(selectPreviousTab:),     @"{", .hidden = YES },
				{ @"Select Next Tab",        @selector(selectNextTab:),         @"}", .hidden = YES },
