...
- (void)applicationDidFinishLaunching:(NSNotification*)aNotification
{
	...
	[swUpdate setChannels:@{
		...
		kSoftwareUpdateChannelPrerelease: [NSURL URLWithString:[@"https://genie.macromates.com/version/prerelease?" stringByAppendingString:parms]],
		kSoftwareUpdateChannelCanary:     [NSURL URLWithString:[@"https://genie.macromates.com/version/canary?"     stringByAppendingString:parms]],
	}];
